...
class LocalNotificationService implements NotificationService {
  ...
  static const _details = NotificationDetails(
    ...
    android: AndroidNotificationDetails('slopetrack_tracking', 'Aufnahme', channelDescription: 'Hinweise während eines Skitags', importance: Importance.high, priority: Priority.high),
  );
