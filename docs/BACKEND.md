...
## Project
- New Supabase project `slopetrack` (EU, Frankfurt). Not the Torch platform project.
...
## Schema (`supabase/migrations/0001_slopetrack.sql`)
| Table | Purpose | RLS |
|---|---|---|
...
4. Later: follows, kudos, share links (`slopetrack.app/d/<id>`).
